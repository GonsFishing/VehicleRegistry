...
namespace CarRegister.Domain.Car
{
    public class Vehicle : IVehicle
    {
		...
		public Vehicle (int id, string model, string carbrand, string cartyp, int carwieght, int year, string licenseplatenumber)
        {
            this.ID = id; 
            this.Model = model;
            this.Brand = carbrand;
        ...
        public bool IsVehicleTrafficReady(IVehicle vehicle)
        {
